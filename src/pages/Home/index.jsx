...
const Home = () => {
  ...
  return (
    <PageWrapper>
      ...
      <div className="bg-brand-linen dark:bg-slate-950 text-brand-espresso dark:text-slate-100 transition-colors duration-500 py-16">
        {/* 2. Brand Showcase */}
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 py-8 border-y border-slate-200/50 dark:border-slate-800/40">
            {brands.map((b) => (
              <div key={b.name} className="flex flex-col items-center select-none group">
                <span
                  className="text-base md:text-xl font-light tracking-[0.25em] text-brand-muted/70 group-hover:text-brand-tan dark:text-brand-muted transition-colors duration-300"
                  style={{ fontFamily: "'Cinzel', serif" }}
                >
                  {b.name}
                </span>
                <span className="text-[8px] tracking-[0.3em] text-brand-muted/70 font-mono mt-1">
                  {b.desc}
                </span>
              </div>
            ))}
        ...
        <section className="max-w-7xl mx-auto px-6 mb-24">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div>
              <p className="text-[10px] tracking-[0.3em] font-semibold text-brand-tan uppercase font-mono mb-2">
                Curated Selection
              </p>
              <h2 className="text-2xl md:text-3xl font-extralight tracking-widest text-brand-espresso dark:text-white" style={{ fontFamily: "'Cinzel', serif" }}>
                Trending Collection
              </h2>
            </div>
            <Link
              to="/shop"
              className="text-xs uppercase tracking-widest font-semibold hover:text-brand-tan text-brand-muted transition-colors mt-4 md:mt-0 flex items-center space-x-1.5"
            >
        ...
        <section className="w-full mb-24 grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="relative aspect-[4/3] md:aspect-auto md:h-[60vh] overflow-hidden group">
            ...
            />
            <div className="absolute inset-0 bg-brand-surface/10 group-hover:bg-brand-surface/20 transition-colors duration-500" />
            <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-10 z-10">
              <div className="bg-white/80 backdrop-blur-md border border-white/40 p-6 md:p-8 rounded-2xl shadow-xl max-w-sm transition-all duration-500 group-hover:translate-y-[-8px] group-hover:bg-white/95">
                <span className="text-[9px] md:text-[10px] tracking-[0.3em] font-mono text-brand-muted mb-1.5 uppercase block">
                  Sartorial Tailoring
                </span>
                <h3 className="text-xl md:text-2xl font-light tracking-widest text-brand-espresso mb-4" style={{ fontFamily: "'Cinzel', serif" }}>
                  MEN'S COLLECTION
                </h3>
                <Link
        ...
        <section className="bg-brand-surface text-brand-espresso py-20 mb-24 rounded-2xl border border-slate-200/50">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-xl mx-auto mb-16">
              <p className="text-[10px] tracking-[0.3em] font-semibold text-brand-muted uppercase font-mono mb-2">
                Exclusive Selection
              </p>
              <h2 className="text-3xl font-extralight tracking-widest uppercase mb-4 text-brand-espresso" style={{ fontFamily: "'Cinzel', serif" }}>
                FASHIONHUB PREMIUM
              </h2>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 py-12 border-y border-slate-200/50 dark:border-slate-800/40">
            <div className="flex flex-col items-center text-center px-4">
              <div className="p-4 bg-amber-500/5 dark:bg-amber-500/10 rounded-full text-brand-tan mb-4">
                <FiTruck className="w-6 h-6" />
              </div>
              <h3 className="text-xs uppercase tracking-widest font-semibold mb-2">
                Global Priority Shipping
              </h3>
              <p className="text-xs text-brand-muted dark:text-brand-muted/70 leading-relaxed max-w-xs">
        ...
        <section className="max-w-4xl mx-auto px-6 text-center mb-12">
          <FaQuoteLeft className="w-8 h-8 text-brand-tan/40 mx-auto mb-6" />
            ...
            {testimonials.map((t, idx) => (
              <div key={idx} className="pb-8 border-b border-slate-200/40 dark:border-slate-800/40 last:border-b-0">
                ...
                <h4 className="text-xs uppercase tracking-widest font-semibold text-slate-800 dark:text-white">
                  {t.author} — <span className="text-brand-tan">{t.location}</span>
                </h4>
              </div>
            ))}
          </div>
